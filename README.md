# Internal Note for ANA-BPHY-2019-03-INT1


## Compiling 
Should compile out of the box by doing `make` provide you have a working latex setup.

If on lxplus or similar, you may need to do
```
